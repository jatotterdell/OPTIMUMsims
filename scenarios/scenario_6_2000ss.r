# Scenario 6 - planned accrual of 5 participants per week ----
# Investigating intervention group probs of 0.068 to 0.062.
...
saveRDS(dat, "~/out_files/optimum_sims/scenario_6_dat.rds")
saveRDS(dec, "~/out_files/optimum_sims/scenario_6_dec.rds")
