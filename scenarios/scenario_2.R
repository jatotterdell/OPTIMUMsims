# Scenario 2 - slow accrual of 5 participants per week ----
...
saveRDS(dat, "~/out_files/optimum_sims/scenario_2_dat.rds")
saveRDS(dec, "~/out_files/optimum_sims/scenario_2_dec.rds")
